...
class HMDBDataset(Dataset):
    def __init__(self,
                 split=None,
                 data_root="data/ucf_hmdb/hmdb/video",
...
class HMDBFeatureDataset(Dataset):
    def __init__(self,
                 split=None,
                 features_root="data/hmdb",
                 data_root="data/hmdb/annotations",
                 max_len=300,
                 num_frames=16,
                 use_mean=False,
                 ):
        ...
        self.split = split
        self.all_actions = ["Climbing", "Fencing", "Golf", "Kick_Ball", "Pullup", "Punch", "Pushup", "Ride_Bike", "Ride_Horse", "Shoot_Ball", "Shoot_Bow", "Walk"]
